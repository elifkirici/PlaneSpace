      ...
      <div className="w-full py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="flex items-center gap-2 group">
            ...
            <h1 className="uppercase text-dark-text font-bold ">plane space</h1>
          </div>
          {/* logo end */}
          ...
          <div>
            <ul className="font-medium flex gap-10 text-dark-text justify-center mt-5">
              <li className="mb-4">
                <a
                  href="/"
                  className="hover:shadow-sm duration-500 text-sm hover:text-base"
                >
                  Deals
                </a>
              </li>
        ...
        <div className="sm:flex items-center justify-center w-full">
          <span className="text-sm font-thin text-dark-text text-center">
            © 2024{" "}
